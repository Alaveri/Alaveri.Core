...
public static class ListExtensions
{
    ...
    /// <param name="action">The <see cref="Proc{TListItem}"/> delegate to perform on each element of the <see cref="IList{TListItem}"/>.</param>
    public static void ForEachIndex<TListItem>(this IList<TListItem> source, Proc<TListItem> action)
    {
